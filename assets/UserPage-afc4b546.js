import{s,g as Mn,_ as K,e as N,f as Je,h as Qe,r as u,R as Rn,i as Ie,j as r,b as C,k as Me,l as Ln,m as Oe,o as Bn,c as Un,p as $n,a as Wn,n as v,L as Kn,q as Nn}from"./index-831654ca.js";import{F as Hn,a as qn,c as Yn,b as de,d as Gn,e as Vn}from"./index.esm-c417ce83.js";import{a as Jn}from"./selectors-9c63f203.js";s.div`
  margin-bottom: 32px;
  position: relative;
  img {
    width: 140px;
...
`;function Hr({pets:e}){const[n]=Nn(),t=async i=>{await n(i).unwrap()};return r.jsxs($r,{children:[r.jsx(Kr,{onClick:()=>t(e._id),children:r.jsx(Nr,{children:r.jsx("use",{href:C+"#iconTrash"})})}),r.jsx(Wr,{src:e.avatarURL,alt:"user-pet"}),r.jsxs("ul",{children:[r.jsxs(fe,{children:[r.jsx("h3",{children:"Name: "}),r.jsx("p",{children:e.name})]}),r.jsxs(fe,{children:[r.jsx("h3",{children:"Date of birth: "}),r.jsx("p",{children:e.date})]}),r.jsxs(fe,{children:[r.jsx("h3",{children:"Type: "}),r.jsx("p",{children:e.type})]}),r.jsxs(fe,{children:[r.jsx("h3",{children:" Comments: "}),r.jsx("p",{children:e.comments})]})]})]})}const qr=()=>{var n,t;const{data:e=[]}=Ie();return r.jsxs("div",{children:[r.jsxs(Mr,{children:[r.jsx(zr,{children:"My pets:"}),r.jsxs(Rr,{to:"/add-pet",state:{from:"/user"},children:[r.jsx(Lr,{children:r.jsx("use",{href:C+"#iconPlusSmall"})}),"Add pet"]})]}),r.jsx(Ir,{children:e.pets&&((n=e.pets)==null?void 0:n.map(i=>r.jsx(Hr,{pets:i},i._id)))}),((t=e.pets)==null?void 0:t.length)===0&&r.jsx(Ur,{})]})},Yr=v.div`
    margin-left: auto;
    margin-right: auto;
    padding: 0px 20px;
      @media only screen and (min-width: 768px) {
...
`;function Xr(){return r.jsx(Gr,{children:r.jsxs(Yr,{children:[r.jsx(_r,{}),r.jsx(qr,{})]})})}export{Xr as default};
