import{n as f,z as _,r as K,A as O,B as tt,j as r,b as w}from"./index-dff294bb.js";const et="min-width: 768px",ot="min-width: 1280px",dt=f.ul`
  display: flex;
...
`,pt=f.svg`
  ...
  transition: 300ms;
`,yt=({id:h,title:a,date:N,category:T,sex:A,location:u,avatarUrl:t,userFavoritesArr:m,showDelete:j})=>{const[I,S]=K.useState(m.includes(h)),[g]=O(),[M]=tt(),[D,v]=K.useState(""),k=new Date,C=new Date(N),o=k.getFullYear()-C.getFullYear(),i=o%2?"year":"years",n=async x=>{x.preventDefault();try{const s=await g(h);s.data&&s.data.message&&await v(s.data.message),B.Notify.success(D),S(c=>!c)}catch{v("Failed to update favorite status"),B.Notify.failure(D)}},b=async x=>{x.preventDefault();try{const s=await M(h);s.data&&B.Notify.success(s.data.name+" was deleted successfully")}catch{B.Notify.failure("Failed to delete notice")}};return r.jsxs(it,{children:[r.jsxs(nt,{children:[r.jsx(at,{src:t}),r.jsx(rt,{children:T}),r.jsx(st,{type:"submit",onClick:n,children:r.jsx(Q,{isFavorite:I,children:r.jsx("use",{href:w+"#iconHeart"})})}),j&&r.jsx(lt,{type:"submit",onClick:b,children:r.jsx(Q,{isFavorite:I,children:r.jsx("use",{href:w+"#iconTrash"})})}),r.jsxs(ct,{children:[r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconLocation"})}),u]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconClock"})}),o," ",i]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:A==="male"?w+"#iconMale":w+"#iconFemale"})}),A]})]})]}),r.jsx(ft,{children:a}),r.jsxs(mt,{children:["Learn more",r.jsx(pt,{children:r.jsx("use",{href:w+"#iconPaw"})})]})]},h)};export{dt as N,yt as a};
