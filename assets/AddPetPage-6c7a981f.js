import{n as N,b as W,u as oe,j as e,s as j,r as y,B as le,D as ie,C as ce}from"./index-5bab7372.js";import{a as p,b as F,F as $,E as b}from"./formik.esm-5ed38b38.js";import{c as A,a as f,d as _,e as de}from"./index.esm-06eb0a0c.js";import{s as d}from"./sprite-f80a4bcd.js";const w=N(p)`
  display: none;
`,me=N.div`
  display: flex;
...
`,ge=A({category:f().required("Select a category")}),fe=r=>{const t=W(),s=oe(),l=()=>{const m=s.state.from;t(m)},o=m=>{r.next(m),console.log(m)};return e.jsx(F,{initialValues:r.data,validationSchema:ge,onSubmit:o,children:e.jsxs($,{children:[e.jsxs(me,{children:[e.jsx(w,{type:"radio",name:"category",id:"your-pet",value:"your-pet"}),e.jsx("label",{htmlFor:"your-pet",children:"your pet"}),e.jsx(w,{type:"radio",name:"category",id:"sell",value:"sell"}),e.jsx("label",{htmlFor:"sell",children:"sell"}),e.jsx(w,{type:"radio",name:"category",id:"lost-found",value:"lost-found"}),e.jsx("label",{htmlFor:"lost-found",children:"lost/found"}),e.jsx(w,{type:"radio",name:"category",id:"in-good-hands",value:"in-good-hands"}),e.jsx("label",{htmlFor:"in-good-hands",children:"in good hands"}),e.jsx(b,{name:"category",component:xe})]}),e.jsxs(v,{className:"buttonNext",type:"submit",children:["Next",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:l,children:[e.jsx(T,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Сancel"]})]})})},J=N.div`
  margin-bottom: 24px;
...
`,P=N.p`
  ...
  line-height: normal;
  color: var(--clr-brand-red);
`,je=A({title:f().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Title must be at least 2 characters").max(16,"Title must be at most 2 characters").required("Enter a title for add"),name:f().min(2,"Name must be at least 2 characters").max(16,"Name must be at most 2 characters").required("Enter a name pet"),date:_().required("Enter a date of birth").max(new Date,"Date cannot be in the future"),type:f().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Type must be at least 2 characters").max(16,"Type must be at most 2 characters").required("Enter a type of pet")}),ye=r=>{const t=s=>{r.next(s),console.log(s)};return e.jsx(F,{initialValues:r.data,validationSchema:je,onSubmit:t,children:({values:s,touched:l,errors:o})=>e.jsxs($,{children:[e.jsxs(J,{children:[e.jsxs("label",{children:["Title of Ad",e.jsx(p,{type:"text",name:"title",placeholder:"Type name pet",className:`${l.title&&o.title?"is-invalid":""}`}),e.jsx(b,{name:"title",component:P})]}),e.jsxs("label",{children:["Pet’s name",e.jsx(p,{type:"text",name:"name",placeholder:"Type name pet",className:`${l.name&&o.name?"is-invalid":""}`}),e.jsx(b,{name:"name",component:P})]}),e.jsxs("label",{children:["Date of Birth",e.jsx(p,{name:"date",type:"date",placeholder:"Type date of birth",className:`${l.date&&o.date?"is-invalid":""}`}),e.jsx(b,{name:"date",component:P})]}),e.jsxs("label",{children:["Type",e.jsx(p,{type:"text",name:"type",placeholder:"Type of pet",className:`${l.type&&o.type?"is-invalid":""}`}),e.jsx(b,{name:"type",component:P})]})]}),e.jsxs(v,{className:"buttonNext",type:"submit",children:["Next",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:()=>r.prev(s),children:[e.jsx(T,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Back"]})]})})},ve=A({name:f().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Name must be at least 2 characters").max(16,"Name must be at most 2 characters").required("Enter a name pet"),date:_().required("Enter a date of birth").max(new Date,"Date cannot be in the future"),type:f().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Type must be at least 2 characters").max(16,"Type must be at most 2 characters").required("Enter a type of pet")}),Ne=r=>{const t=s=>{r.next(s),console.log(s)};return e.jsx(F,{initialValues:r.data,validationSchema:ve,onSubmit:t,children:({values:s,touched:l,errors:o})=>e.jsxs($,{children:[e.jsxs(J,{children:[e.jsxs("label",{children:["Pet’s name",e.jsx(p,{type:"text",name:"name",placeholder:"Type name pet",className:`${l.name&&o.name?"is-invalid":""}`}),e.jsx(b,{name:"name",component:P})]}),e.jsxs("label",{children:["Date of Birth",e.jsx(p,{type:"date",name:"date",placeholder:"Type date of birth",className:`${l.date&&o.date?"is-invalid":""}`}),e.jsx(b,{name:"date",component:P})]}),e.jsxs("label",{children:["Type",e.jsx(p,{type:"text",name:"type",placeholder:"Type of pet",className:`${l.type&&o.type?"is-invalid":""}`}),e.jsx(b,{name:"type",component:P})]})]}),e.jsxs(v,{className:"buttonNext",type:"submit",children:["Next",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:()=>r.prev(s),children:[e.jsx(T,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Back"]})]})})},B=j.img`
