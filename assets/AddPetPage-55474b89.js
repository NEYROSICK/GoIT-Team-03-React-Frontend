import{n as y,c as J,u as oe,j as e,b as c,s as f,r as v,J as le,K as ce,C as de}from"./index-7f0e667c.js";import{a as x,c as E,b as j,e as F,F as $,E as u,d as _,g as me}from"./index.esm-c0b8677a.js";const I=y(x)`
  display: none;
`,xe=y.div`
  display: flex;
...
`,ee=f.p`
  ...
  line-height: normal;
  color: var(--clr-brand-red);
`,ke=E({comments:j().min(2,"Comments must be at least 2 characters").required("Enter a comment")}),Pe=i=>{const[t,n]=v.useState(i.selectedFile||null),[o,r]=v.useState(!1),[g,S]=v.useState(""),p=l=>{const s=l.target.files[0];s&&(s.type==="image/jpeg"||s.type==="image/png")?(n(s),S("")):(n(null),S("Please select a JPEG or PNG"))},w=l=>{if(!t){r(!0);return}i.next(l,!0,t)};return e.jsx(F,{initialValues:i.data,validationSchema:ke,onSubmit:w,children:({values:l,touched:s,errors:d})=>e.jsx($,{children:e.jsxs(Y,{children:[e.jsxs(G,{children:[e.jsx("p",{children:"Choose pet image:"}),e.jsxs(R,{className:g!==""||o&&!t?"no-image-selected":"",children:[t?e.jsx("div",{children:e.jsx(O,{src:URL.createObjectURL(t),alt:"User's file",style:{maxWidth:"300px"}})}):e.jsxs(e.Fragment,{children:[e.jsx(V,{children:e.jsx("use",{href:c+"#iconPlusAvatar"})}),e.jsx(we,{children:e.jsx("use",{href:c+"#iconPlus"})})]}),e.jsx(U,{type:"file",name:"image",accept:"image/jpeg, image/png",onChange:p})]})]}),g&&e.jsx(Z,{children:g}),e.jsxs("label",{children:["Comments",e.jsx(x,{as:"textarea",type:"text",name:"comments",placeholder:"Type of pet",className:`${s.comments&&d.comments?"is-invalid":""}`}),e.jsx(u,{name:"comments",component:P})]}),e.jsxs(A,{children:[e.jsxs(N,{className:"buttonNext",type:"submit",children:["Done",e.jsx(C,{children:e.jsx("use",{href:c+"#iconPaw"})})]}),e.jsxs(N,{className:"buttonBack",type:"button",onClick:()=>i.prev(l,t),children:[e.jsx(z,{children:e.jsx("use",{href:c+"#iconArrowLeft"})}),"Back"]})]})]})})})},Ee=E({sex:j().required("Select a sex"),location:j().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Location must be at least 2 characters").required("Enter a location"),comments:j().min(2,"Comments must be at least 2 characters").required("Enter a comment")}),Fe=i=>{const[t,n]=v.useState(i.selectedFile||null),[o,r]=v.useState(!1),[g,S]=v.useState(""),p=l=>{const s=l.target.files[0];s&&(s.type==="image/jpeg"||s.type==="image/png")?(n(s),S("")):(n(null),S("Please select a JPEG or PNG"))},w=l=>{if(!t){r(!0);return}i.next(l,!0,t)};return e.jsx(F,{initialValues:i.data,validationSchema:Ee,onSubmit:w,children:({values:l,touched:s,errors:d})=>e.jsx($,{children:e.jsxs(Y,{children:[e.jsxs(X,{children:[e.jsx("p",{children:"The Sex"}),e.jsxs(D,{children:[e.jsx(x,{type:"radio",name:"sex",id:"female",value:"female",className:`${s.sex&&d.sex?"is-invalid":""}`}),e.jsxs("label",{htmlFor:"female",children:[e.jsx(H,{className:"iconFemale",children:e.jsx("use",{href:c+"#iconFemale"})}),"Female"]}),e.jsx(x,{type:"radio",name:"sex",id:"male",value:"male",className:`${s.sex&&d.sex?"is-invalid":""}`}),e.jsxs("label",{htmlFor:"male",children:[e.jsx(Q,{className:"iconMale",children:e.jsx("use",{href:c+"#iconMale"})}),"Male"]}),e.jsx(u,{name:"sex",component:ee})]})]}),e.jsxs(G,{children:[e.jsx("p",{children:"Choose pet image:"}),e.jsxs(R,{className:g!==""||o&&!t?"no-image-selected":"",children:[t?e.jsx("div",{children:e.jsx(O,{src:URL.createObjectURL(t),alt:"User's file",style:{maxWidth:"300px"}})}):e.jsx(V,{children:e.jsx("use",{href:c+"#iconPlusAvatar"})}),e.jsx(U,{type:"file",name:"image",accept:"image/jpeg, image/png",onChange:p})]})]}),g&&e.jsx(Z,{children:g}),e.jsxs("label",{children:["Location",e.jsx(x,{className:`${s.location&&d.location?"is-invalid":""}`,type:"text",name:"location",placeholder:"Type of location"}),e.jsx(u,{name:"location",component:P})]}),e.jsxs("label",{children:["Comments",e.jsx(x,{type:"text",as:"textarea",name:"comments",placeholder:"Type of pet",className:`${s.comments&&d.comments?"is-invalid":""}`}),e.jsx(u,{name:"comments",component:P})]}),e.jsxs(A,{children:[e.jsxs(N,{className:"buttonNext",type:"submit",children:["Done",e.jsx(C,{children:e.jsx("use",{href:c+"#iconPaw"})})]}),e.jsxs(N,{className:"buttonBack",type:"button",onClick:()=>i.prev(l,t),children:[e.jsx(z,{children:e.jsx("use",{href:c+"#iconArrowLeft"})}),"Back"]})]})]})})})},$e=E({sex:j().required("Select a sex"),location:j().matches(/^[a-zA-Z\s]+$/,"Enter only English letters").min(2,"Location must be at least 2 characters").required("Enter a location"),price:me().typeError("Type a valid number").required("Enter a price"),comments:j().min(2,"Comments must be at least 2 characters").required("Enter a comment")}),Ae=i=>{const[t,n]=v.useState(i.selectedFile||null),[o,r]=v.useState(!1),[g,S]=v.useState(""),p=l=>{const s=l.target.files[0];s&&(s.type==="image/jpeg"||s.type==="image/png")?(n(s),S("")):(n(null),S("Please select a JPEG or PNG"))},w=l=>{if(!t){r(!0);return}i.next(l,!0,t)};return e.jsx(F,{initialValues:i.data,validationSchema:$e,onSubmit:w,children:({values:l,touched:s,errors:d})=>e.jsxs($,{children:[e.jsxs(Y,{children:[e.jsxs(X,{children:[e.jsx("p",{children:"The Sex"}),e.jsxs(D,{children:[e.jsx(x,{type:"radio",name:"sex",id:"female",value:"female",className:`${s.sex&&d.sex?"is-invalid":""}`}),e.jsxs("label",{htmlFor:"female",children:[e.jsx(H,{className:"iconFemale",children:e.jsx("use",{href:c+"#iconFemale"})}),"Female"]}),e.jsx(x,{type:"radio",name:"sex",id:"male",value:"male",className:`${s.sex&&d.sex?"is-invalid":""}`}),e.jsxs("label",{htmlFor:"male",children:[e.jsx(Q,{className:"iconMale",children:e.jsx("use",{href:c+"#iconMale"})}),"Male"]}),e.jsx(u,{name:"sex",component:ee})]})]}),e.jsxs(G,{children:[e.jsx("p",{children:"Choose pet image:"}),e.jsxs(R,{className:g!==""||o&&!t?"no-image-selected":"",children:[t?e.jsx("div",{children:e.jsx(O,{src:URL.createObjectURL(t),alt:"User's file",style:{maxWidth:"300px"}})}):e.jsx(V,{children:e.jsx("use",{href:c+"#iconPlusAvatar"})}),e.jsx(U,{type:"file",name:"image",accept:"image/jpeg, image/png",onChange:p})]})]}),g&&e.jsx(Z,{children:g}),e.jsxs("label",{children:["Location",e.jsx(x,{className:`${s.location&&d.location?"is-invalid":""}`,type:"text",name:"location",placeholder:"Type of location"}),e.jsx(u,{name:"location",component:P})]}),e.jsxs("label",{children:["Price",e.jsx(x,{type:"text",name:"price",placeholder:"Type of price",className:`${s.price&&d.price?"is-invalid":""}`}),e.jsx(u,{name:"price",component:P})]}),e.jsxs("label",{children:["Comments",e.jsx(x,{className:`${s.comments&&d.comments?"is-invalid":""}`,as:"textarea",type:"text",name:"comments",placeholder:"Type of pet"}),e.jsx(u,{name:"comments",component:P})]})]}),e.jsxs(A,{children:[e.jsxs(N,{className:"buttonNext",type:"submit",children:["Done",e.jsx(C,{children:e.jsx("use",{href:c+"#iconPaw"})})]}),e.jsxs(N,{className:"buttonBack",type:"button",onClick:()=>i.prev(l,t),children:[e.jsx(z,{children:e.jsx("use",{href:c+"#iconArrowLeft"})}),"Back"]})]})]})})},Ce=()=>{const i=J(),[t,n]=v.useState(0),[o,r]=v.useState(null),[g]=le(),[S]=ce(),[p,w]=v.useState({category:"",title:"",name:"",date:"",type:"",sex:"",location:"",price:"",comments:""}),l=a=>{w({category:a,title:"",name:"",date:"",type:"",sex:"",location:"",price:"",comments:""})},s=(a,h)=>{const m=new FormData,b=q=>{const M=new Date(q),se=String(M.getDate()).padStart(2,"0"),ie=String(M.getMonth()+1).padStart(2,"0"),re=M.getFullYear();return`${se}-${ie}-${re}`};let L={};a.category==="your-pet"&&(L={name:a.name,date:b(a.date),type:a.type,comments:a.comments,image:h}),a.category==="sell"&&(L={category:a.category,title:a.title,name:a.name,date:b(a.date),type:a.type,sex:a.sex,location:a.location,comments:a.comments,price:a.price,image:h}),(a.category==="lost-found"||a.category==="in-good-hands")&&(L={category:a.category,title:a.title,name:a.name,date:b(a.date),type:a.type,sex:a.sex,location:a.location,comments:a.comments,image:h});for(const[q,M]of Object.entries(L))m.append(q,M);a.category==="your-pet"?g(m):S(m),l("");const ne=m.category==="your-pet"?"/user":"/notices";i(ne)},d=(a,h=!1,m="")=>{if(w(b=>({...b,...a})),h){s(a,m);return}switch(a.category){case"your-pet":n(b=>b+1),t===0&&a.category!==p.category&&(l(a.category),r(null));break;case"sell":t===0&&(a.category!==p.category&&(l(a.category),r(null)),n(b=>b+3)),t===3&&n(b=>b+2);break;default:t===0&&(a.category!==p.category&&(l(a.category),r(null)),n(b=>b+3)),t===3&&n(b=>b+1)}},T=(a,h="")=>{switch(w(m=>({...m,...a})),a.category){case"your-pet":n(m=>m-1),h!==""&&r(h);break;case"sell":t===3&&(n(m=>m-3),h!==""&&r(h)),t===5&&(n(m=>m-2),h!==""&&r(h));break;default:t===3&&(n(m=>m-3),h!==""&&r(h)),t===4&&(n(m=>m-1),h!==""&&r(h))}},te=[e.jsx(je,{next:d,data:p,selectedFile:o}),e.jsx(Se,{next:d,prev:T,data:p,selectedFile:o}),e.jsx(Pe,{next:d,prev:T,data:p,selectedFile:o}),e.jsx(ve,{next:d,prev:T,data:p,selectedFile:o}),e.jsx(Fe,{next:d,prev:T,data:p,selectedFile:o}),e.jsx(Ae,{next:d,prev:T,data:p,selectedFile:o})],ae=()=>{switch(p.category){case"your pet":return"Add pet";case"sell":return"Add pet for sale";case"lost/found":return"Add lost pet";case"in good hands":return"In good hands";default:return"Add pet"}};return e.jsx(e.Fragment,{children:e.jsx(de,{children:e.jsx(he,{children:e.jsxs(ue,{children:[e.jsx(ge,{children:t===0?"Add pet":ae()}),e.jsxs(be,{children:[e.jsxs("li",{className:t===0?"is-selected":"is-done",children:["Choose option"," "]}),e.jsx("li",{className:t===1||t===3?"is-selected":t===0?"":"is-done",children:"Personal details"}),e.jsx("li",{className:t===2||t===4||t===5?"is-selected":"",children:"More info"})]}),te[t]]})})})})},Me=()=>e.jsx(Ce,{});export{Me as default};
