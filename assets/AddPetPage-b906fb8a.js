import{n as y,c as J,u as re,j as e,b as c,s as f,r as v,J as le,K as ce,C as de}from"./index-915085f2.js";import{a as x,c as E,b as j,e as F,F as $,E as g,d as _,g as me}from"./index.esm-099a2614.js";const I=y(x)`
  display: none;
`,xe=y.div`
  display: flex;
...
`,fe=E({category:j().required("Select a category")}),je=i=>{const t=J(),a=re(),r=()=>{a.state?t(a.state.from):t("/user")},o=p=>{i.next(p),console.log(p)};return e.jsx(F,{initialValues:i.data,validationSchema:fe,onSubmit:o,children:e.jsxs($,{children:[e.jsxs(xe,{children:[e.jsx(I,{type:"radio",name:"category",id:"your-pet",value:"your-pet"}),e.jsx("label",{htmlFor:"your-pet",children:"your pet"}),e.jsx(I,{type:"radio",name:"category",id:"sell",value:"sell"}),e.jsx("label",{htmlFor:"sell",children:"sell"}),e.jsx(I,{type:"radio",name:"category",id:"lost-found",value:"lost-found"}),e.jsx("label",{htmlFor:"lost-found",children:"lost/found"}),e.jsx(I,{type:"radio",name:"category",id:"in-good-hands",value:"in-good-hands"}),e.jsx("label",{htmlFor:"in-good-hands",children:"in good hands"}),e.jsx(g,{name:"category",component:pe})]}),e.jsxs(A,{children:[e.jsxs(N,{className:"buttonNext",type:"submit",children:["Next",e.jsx(C,{children:e.jsx("use",{href:c+"#iconPaw"})})]}),e.jsxs(N,{className:"buttonBack",type:"button",onClick:r,to:a.state.from,children:[e.jsx(z,{children:e.jsx("use",{href:c+"#iconArrowLeft"})}),"Сancel"]})]})]})})},K=y.div`
