import{n as f,y as _,z as Z,A as O,r as tt,j as r}from"./index-6532b15c.js";import{s as w}from"./sprite-6f002047.js";const et="min-width: 768px",ot="min-width: 1280px",yt=f.ul`
  display: flex;
...
`,pt=f.svg`
  ...
  transition: 300ms;
`,ut=({id:h,title:a,date:N,category:T,sex:z,location:g,avatarUrl:t,isFavorite:c,showDelete:A})=>{const[j]=Z(),[M]=O(),[x,D]=tt.useState(""),S=new Date,k=new Date(N),b=S.getFullYear()-k.getFullYear(),I=b%2?"year":"years",o=async i=>{i.preventDefault();try{const l=await j(h);l.data&&l.data.message&&await D(l.data.message),B.Notify.success(x)}catch{D("Failed to update favorite status"),B.Notify.failure(x)}},n=async i=>{i.preventDefault();try{const l=await M(h);l.data&&B.Notify.success(l.data.name+" was deleted successfully")}catch{B.Notify.failure("Failed to delete notice")}};return r.jsxs(it,{children:[r.jsxs(nt,{children:[r.jsx(at,{src:t}),r.jsx(rt,{children:T}),r.jsx(st,{type:"submit",onClick:o,children:r.jsx(K,{isFavorite:c,children:r.jsx("use",{href:w+"#iconHeart"})})}),A&&r.jsx(lt,{type:"submit",onClick:n,children:r.jsx(K,{isFavorite:c,children:r.jsx("use",{href:w+"#iconTrash"})})}),r.jsxs(ct,{children:[r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconLocation"})}),g]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconClock"})}),b," ",I]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:z==="male"?w+"#iconMale":w+"#iconFemale"})}),z]})]})]}),r.jsx(ft,{children:a}),r.jsxs(mt,{children:["Learn more",r.jsx(pt,{children:r.jsx("use",{href:w+"#iconPaw"})})]})]},h)};export{yt as N,ut as a};
