...
`,ft=c.svg`
  ...
  transition: 300ms;
`,dt=({id:g,title:a,date:N,category:B,sex:z,location:u,avatarUrl:t,userFavoritesArr:f,showDelete:A})=>{const[j,T]=Z.useState(f.includes(g)),[h]=O(),[S]=tt(),E=new Date,k=new Date(N),v=E.getFullYear()-k.getFullYear(),I=v%2?"year":"years",o=async i=>{i.preventDefault();try{const l=await h(g);l.data&&l.data.message&&W.Notify.success("Success!"),T(b=>!b)}catch{W.Notify.failure("Failed to update favorite status")}},n=async i=>{i.preventDefault();try{const l=await S(g);l.data&&W.Notify.success(l.data.name+" was deleted successfully")}catch{W.Notify.failure("Failed to delete notice")}};return r.jsxs(et,{children:[r.jsxs(ot,{children:[r.jsx(it,{src:t}),r.jsx(nt,{children:B}),r.jsx(at,{type:"submit",onClick:o,children:r.jsx(K,{isFavorite:j,children:r.jsx("use",{href:w+"#iconHeart"})})}),A&&r.jsx(rt,{type:"submit",onClick:n,children:r.jsx(K,{children:r.jsx("use",{href:w+"#iconTrash"})})}),r.jsxs(st,{children:[r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconLocation"})}),u]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:w+"#iconClock"})}),v," ",I]}),r.jsxs(G,{children:[r.jsx(R,{children:r.jsx("use",{href:z==="male"?w+"#iconMale":w+"#iconFemale"})}),z]})]})]}),r.jsx(lt,{children:a}),r.jsxs(ct,{children:["Learn more",r.jsx(ft,{children:r.jsx("use",{href:w+"#iconPaw"})})]})]},g)},mt="min-width: 768px",pt="min-width: 1280px",yt=c.ul`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-wrap: wrap;
